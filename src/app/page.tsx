...
const fetchMLS = async (
    ...
    return fetch("https://api2.realtor.ca/Listing.svc/PropertySearch_Post", {
        ...
        body: `ZoomLevel=14&LatitudeMax=45.55318&LongitudeMax=-73.53407&LatitudeMin=45.50333&LongitudeMin=-73.63354&Sort=6-D&PropertyTypeGroupID=1&PropertySearchTypeId=0&TransactionTypeId=2&PriceMin=${priceBucket.min}&PriceMax=${priceBucket.max}&BedRange=1-0&Currency=CAD&RecordsPerPage=40&ApplicationId=1&CultureId=2&Version=7.0&CurrentPage=${page}`,
        method: "POST",
    }).then((res) => res.json());
};
